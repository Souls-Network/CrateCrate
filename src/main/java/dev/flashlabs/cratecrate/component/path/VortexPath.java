...
public final class VortexPath extends Path {
    ...
    public static VortexPath deserialize(ConfigurationNode node) {
        ...
        return new VortexPath(interval, precision, segments, shift, speed, scale);
    }
