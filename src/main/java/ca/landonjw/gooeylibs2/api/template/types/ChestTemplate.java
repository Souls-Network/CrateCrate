...
public class ChestTemplate extends Template {
    ...
    public ChestTemplate clone() {
        ...
        for (int i = 0; i < getSize(); i++) {
            TemplateSlotDelegate button = new TemplateSlotDelegate(this.getSlot(i).getButton().orElse(null), i);
            results[i] = button;
        }
    ...
    public static class Builder {
        ...
        public ChestTemplate build() {
            ...
            templateInstance = new ChestTemplate(TemplateHelper.slotsOf(COLUMNS * rows));
